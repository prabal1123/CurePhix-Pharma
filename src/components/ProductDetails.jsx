...
export default function ProductDetails() {
  ...
  const baseURL = "https://xzpyaylnaakhtfqshhmv.supabase.co/storage/v1/object/public/Work/";

  const products = {
    Arginuron: {
      image: baseURL + "1.Arginuron.png",
      description: "Male fertility and antioxidant support supplement",
      composition: ["L-Arginine", "Lycopene", "Antioxidants and micronutrients"],
      indications: ["Male fertility support", "Fatigue and weakness", "Nutritional deficiency"],
      benefits: ["Supports nitric oxide", "Improves circulation", "Provides antioxidant protection"]
    },
    Rovafeno: {
      image: baseURL + "2.Rovafeno.png",
      description: "Lipid lowering therapy for cholesterol management",
      composition: ["Rosuvastatin 10 mg", "Fenofibrate 160 mg"],
      indications: ["Mixed dyslipidemia", "High cholesterol", "Cardiovascular risk"],
      benefits: ["Dual action", "Reduces LDL", "Improves HDL"]
    },
    Argilyco: {
      image: baseURL + "3Argilyco.png",
      description: "Advanced antioxidant and cardiovascular support formula",
      composition: ["Lycopene 10%", "Coenzyme Q10", "L-Arginine", "Zinc", "Folic Acid", "Selenium"],
      indications: ["Cardiovascular health", "Male fertility support", "General wellness"],
      benefits: ["Heart health", "Sperm quality", "Reduces oxidative stress"]
    },
    Farotos: {
      image: baseURL + "4.Farotos.png",
      description: "Broad-spectrum oral antibiotic for bacterial infections",
      composition: ["Faropenem Sodium 200 mg"],
      indications: ["Respiratory tract infections", "Urinary tract infections", "Skin infections"],
      benefits: ["Effective against resistant bacteria", "Good tissue penetration", "Stable antibiotic"]
    },
    Panzora: {
      image: baseURL + "5.Panzora.png",
      description: "Dual-action therapy for acidity and reflux disorders",
      composition: ["Pantoprazole Sodium 40 mg", "Domperidone 30 mg"],
      indications: ["GERD", "Acidity", "Gastritis", "Peptic ulcer"],
      benefits: ["Acid secretion reduction", "Gastric motility improvement", "Symptom control"]
    }
  };
...
<button className="back-btn" onClick={() => navigate(-1)}>
  ← Back to Products
      ...
      <div className="details-container">
        ...
        <div className="product-info">
          <span className="tag">PHARMACEUTICAL PRODUCT</span>
          <h1>{name}</h1>
          <p className="desc">{product.description}</p>
